//$ PLANS
/*TODO {
  [ ] figure out how to create multi-part rigid bodies
  [ ] set belongsTo and collidesWith
  [ ] separate executing Oimo steps from babylon
  [ ] create objects that can be passed through but detect{
    [ ]belongsToDetect
    [ ]detectsWith
  }
}
Callbacks{
  collision callbacks{
      [ ] startCollision called once for every new collision
      [ ] duringCollision called every step objects are collided
      [ ] afterCollision called once object separates from another objects
    }
